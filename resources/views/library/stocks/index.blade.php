...
@can('stock_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12 mt-2">
           <a class="btn btn-success" href="{{ route("library.stocks.create") }}">
                ...
                <tbody>
                    @foreach($stocks as $key => $stock)
                        <tr>
                            ...
                            @user
                                <td>
                                    <form action="{{ route('library.transactions.storeStock', $stock->id) }}" method="POST" style="display: inline-block;" class="form-inline">
                            ...
                            <td>
                                @can('stock_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('library.stocks.show', $stock->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
                            </td>
