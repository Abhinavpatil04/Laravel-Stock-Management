...
class StocksController extends Controller
{
    public function index()
    {
        ...
        return view('library.stocks.index', compact('stocks'));
    }
    ...
    public function create()
    {
        ...
        return view('library.stocks.create', compact('assets'));
    }
    ...
    public function store(StoreStockRequest $request)
    {
        ...
        return redirect()->route('library.stocks.index');
    ...
    public function edit(Stock $stock)
    {
        ...
        return view('library.stocks.edit', compact('assets', 'stock'));
    }
    ...
    public function show(Stock $stock)
    {
        ...
        return view('library.stocks.show', compact('stock'));
    }
